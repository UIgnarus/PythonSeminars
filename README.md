...
### Семинар 5
* task21 - Крестики-нолики (не завершено, дописано в домашке)
* task21_1 - Крестики-нолики (из сети)
 
### Семинар 6
* task23 - устранение элементов с "абв" (домашка)
* task24 - сжатие строки (домашка)
* task25 - калькулятор из строки (доработка!)
* task26 - пример кода калькулятора в строку
* -- Дана последовательность чисел. Получить список уникальных элементов заданной последовательности.  *Пример:*   [1, 2, 3, 5, 1, 5, 3, 10] => [2, 10] (В работе!)
### Семинар 7

* task31 - калькулятор рациональныйх и комплексных (В работе!)

### Семинар 8
* task32 - телефонный справочник

### Семинар 9
* task32 - телефонный справочник (доработка!)

### Семинар 10

* task33 - streamlit (Доработка!)
